...
- **Below 768px the brand and nav rows scroll away and only search + categories stay.** The top bar wraps to three rows on a phone, so pinning all of it would hold 233px of an 812px screen; this holds 128px. Done with a negative sticky top set from `--head-offset`.
